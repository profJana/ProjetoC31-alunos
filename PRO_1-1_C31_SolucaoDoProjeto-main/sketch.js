...
function draw() {
  ...
  for (var stone of stones) {
    ...
    //verifica a distancia da posição x e y do zombie com o pos.x e pos.y (da pedra)
    //var distance = (zombie.position.x, zombie.position.y, pos.x, pos.y);
    //var distance = dist(zombie.position.x, zombie.position.y, pos.x, pos.y);
    //var distance = dist(zombie.position, zombie.position, pos, pos);
    //var distance = dist(zombie.position.x, zombie.position.y);

    //se distancia é <= 50, a velocidadeX do zombie é igual a 0, muda a imagem do zumbi para triste e muda a variável collided para verdadeiro
